...
fileIncludes('package.json', '"lint:filenames": "node scripts/audit-file-names.js"', 'Filename audit script');
fileIncludes('package.json', '"lint:code": "next lint"', 'Next code lint script');
fileIncludes('package.json', '"lint:repo": "node scripts/audit-file-names.js && node scripts/lint-project.js"', 'Repo lint script');
